...
public class SuggestTrackingDialog {
    ...
    public SuggestTrackingDialog(Context mContext, DisplayTrackablesListActivity activity) {
    ...
    public void openDialog() {
        ...
        else if (tabWidgetActivity != null) {
            view = tabWidgetActivity.getLayoutInflater().inflate(R.layout.dialog, null);
        }
